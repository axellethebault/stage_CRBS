...
fig_t_sne = px.scatter(df_t_sne, x='proj_x',y='proj_y', title='Projection t-SNE coordonnées de P04386_GAL4_supCEP3.pdb', color='numero atome', color_continuous_scale=px.colors.sequential.Turbo)
fig_t_sne.show()
print('coordonnées projetées de P04386_GAL4_supCEP3.pdb',df_t_sne)
